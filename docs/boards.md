...
| [`a2mega`](../boards/a2mega/README.md) | Tang Mega 60K / GW5AT-LV60PG484AC1/I0 | DDR3 | DDR3 | BSRAM | `a2mega.gprj` | WIP, active development — ESP32-S3 co-processor port of the Enhanced feature set (menu, SD disk serving, WiFi Uthernet II, FPGA self-update) in bring-up |
...
| Board | Board docs |
|---|---|
| [a2mega](../boards/a2mega/README.md) | DDR3 framebuffer refactor workplan, DDR3 480p design, scan-timer design, ESP32 OSPI protocol, ESP32 Enhanced-port design, TransWarp GS reference (`boards/a2mega/docs/`) |
